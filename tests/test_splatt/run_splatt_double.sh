...
do
	...
	do
		...
		do
			...
			echo "splatt bench ${tsr_path}/${tsr_name}.tns -a splatt -r ${R} -t ${th} > ${out_path}/${tsr_name}-r${R}-t${th}.txt"
			splatt bench ${tsr_path}/${tsr_name}.tns -a splatt -r ${R} -t ${th} > ${out_path}/${tsr_name}-r${R}-t${th}.txt
