...
splatt_path="/global/homes/j/jiajiali/Software/Install/splatt-ipdps17/int32-float"
out_path="/global/homes/j/jiajiali/Work/ParTI-dev/timing-results/splatt/32bit-single-allmode-tiling"
