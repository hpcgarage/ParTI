...
do
	...
	do
		...
		do
			...
			echo "/opt/splatt-float/bin/splatt bench ${tsr_path}/${tsr_name}.tns -a splatt -r ${R} -t ${th} > ${out_path}/${tsr_name}-r${R}-t${th}.txt"
			/opt/splatt-float/bin/splatt bench ${tsr_path}/${tsr_name}.tns -a splatt -r ${R} -t ${th} > ${out_path}/${tsr_name}-r${R}-t${th}.txt
